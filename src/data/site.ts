...
export const services: ServiceBlock[] = [
  {
    ...
    paragraphs: [
      ...
      'Da kan det være nyttig å få hjelp fra en profesjonell som kan gi deg innspill, innsikt og verktøy for hvordan gå videre så du ikke blir begrenset av problemene dine. Bakgrunnen for å komme til samtale hos oss kan være et ønske om selvutvikling, opplevelse av tristhet, angst symptomer, bekymringer, følelsen av og ikke strekke til, vonde tanker og følelser og mange andre ting.',
    ],
  },
  {
    title: 'Onlineterapi',
    paragraphs: [
      ...
      'Man kan delta fra hvor som helst i verden, noe som tilbyr fleksibilitet i en travel hverdag. Online terapi kan være like effektivt som tradisjonell terapi med personlig oppmøte. For å sikre en best mulig opplevelse, er det imidlertid noen forberedelser som kan være nyttige:',
    ],
    groups: [
      {
...
export const method = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'I kognitiv atferdsterapi vil din deltagelse være avgjørende for et best mulig resultat. Egen aktivitet er viktig for at terapien skal ha best mulig effekt, og man vil derfor ofte inkludere noen oppgaver eller aktiviteter mellom timene. Du er imidlertid alltid selv med på å avgjøre innhold og fremdrift i dette. Et sentralt mål i kognitiv atferdsterapi er at du skal få kunnskap og verktøy som du kan ta i bruk når du senere opplever utfordrende livssituasjoner.',
      ],
    },
    {
...
export const pricing = {
  ...
  packageExplainerTitle: 'Hva innebærer en terapi pakke?',
  packageExplainer:
