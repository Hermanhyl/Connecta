...
/**
 * Tabbed view for the "Onlineterapi" preparation groups.
 * Shows one group at a time in a comfortable reading width so the bullet
 * lists no longer stretch into tall, thin columns.
 */
        ...
        {groups.map((g, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="relative leading-snug">{g.heading}</span>
            </button>
          )
        })}
      </div>
